...
import com.zerobase.cms.order.application.OrdersApplication;
...
public class CustomerCartController {
    ...
    private final OrdersApplication orderApplication;

    @PostMapping
    public ResponseEntity<Cart> addCart(
            @RequestHeader(name = "X-AUTH-TOKE") String token,
